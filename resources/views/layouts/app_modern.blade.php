      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="#" class="text-nowrap logo-img">
            <img src="/modern/src/assets/images/logos/logoklinik.png" width="180" alt="" />
          </a>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
                <a class="sidebar-link {{ request()->is('laporan-pasien') ? 'active' : '' }}" href="/laporan-pasien" aria-expanded="false">
                  <span>
                    <i class="ti ti-user"></i>
                  </span>
            ...
            <li class="sidebar-item">
                <a class="sidebar-link {{ request()->is('laporan-daftar') ? 'active' : '' }}" href="/laporan-daftar" aria-expanded="false">
                  <span>
                    <i class="ti ti-user"></i>
                  </span>
